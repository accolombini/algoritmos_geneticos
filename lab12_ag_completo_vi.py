# Title     : Algoritmo Genético Completo -> versão inicial
# Objective : Neste laboratório vamos unir todos os laboratórios construindo a versão inicial do AG completo
# Created by: accol
...
# Criaremos uma nova variável chamada numeroGerações => trabalharemos com número de gerações igual a 100
# Criaremos uma nova função chamada visualizaGeracao
