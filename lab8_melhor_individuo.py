...
# Neste laboratório precisaremos criar uma função que nos permita encontrar qual o melhor indivíduo, ou seja, dentre todos os indivíduos da nossa população qual aquele com a melhor opção de resposta aos requisitos do nosso problema
# Para a seleção do indíviduo mais apto usaremos os resultados da avaliação do laboratório anterior, ou seja, os indivíduos mais aptos estarão nas primeiras posições. Neste laboratório criaremos a função melhorIndividuo => também trabalharemos com 100 Gerações -> lembre-se que este valor deve ser exautivamente trabalhado para que encontre a melhor opção para o seu projeto
...
if __name__ =='__main__':
    ...
    print('\n***Melhor solucao para o problema: %s' % ag.melhor_solucao.cromossomo,
