# Title     : Inicialização da população
# Objective : Neste laboratório vamos a partir dos indivíduos criados anteriormente gerar uma população, para que possamos trabalhar melhor o conceito de evolução das gerações e buscarmos o individuo melhor adaptado (aquele que trará a solução mais interessante para a empresa de logistica)
# Created by: accol
# Created on: 11/06/2020


# Importante -> você deverá definir quantos indivíduos farão parte de sua população inicial (ajustes podem ser feito dada a precisão desejada => Neste laboratório trabalharemos com uma população de 20 indivíduos
